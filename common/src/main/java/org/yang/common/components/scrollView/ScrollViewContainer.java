package org.yang.common.components.scrollView;
...
public class ScrollViewContainer extends RelativeLayout {
                ...
                if (state == AUTO_UP) {
                    ...
                    if (mMoveLen <= -mViewHeight) {
                        ...
                        if (mScrollStateChangeListener != null) {
                            mScrollStateChangeListener.onStateChange(AUTO_DOWN);
                        }
                    }
                    ...
                    if (mMoveLen >= 0) {
                        ...
                        mCurrentViewIndex = 0;
                        if (mScrollStateChangeListener != null) {
                            mScrollStateChangeListener.onStateChange(AUTO_UP);
                        }
                    }
                } else {
                    mTimer.cancel();
    ...
    public void setScrollStateChangeListener(ScrollStateChangeListener mScrollStateChangeListener) {
